...
/*Procedimento pega um nÃ³ adicionado no grafo e empilha os filhos a esquerda
 * caso o filho da esquerda do nÃ³ for diferente de nulo
 * */
...
/*Procedimento auxiliar para alocar alocar um espaï¿½o na heap e
...
void reduz_K(Celula *grafo){
	...
	newA->fdir = a->fdir;
	newA->fesq = a->fesq;
	//Adicionou verificaï¿½ï¿½o do pai
	//if(topo != NULL){
	if(topo >= 0){
		pai = pilha[topo];
	}
...
/*Procedimento efetua a reduÃ§ao do combinador I no grafo segundo a regra
 *  I a -> a
 * */
...
int main(){
	/**
	 * CriaÃ§Ã£o e alocaÃ§ao do grafo.
	 * */
	aloca_freelist();
	...
	clock_t tic = clock();
	printf("\n");
	printf("Tempo CriaÃ§Ã£o do grafo = %lf", (double)((tic - toc)/clk_ps));
	...
	printf("\n");
	printf("Tempo ReduÃ§Ã£o grafo = %lf", (double)((b - a)/clk_ps));
	printf("\nNumero de iteraÃ§Ãµes = %d\n",iterations);
