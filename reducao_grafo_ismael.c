...
//Declaracao da funcao para que a mesma possa ser utilizada
 ...
 * nas reducoes.
 * */
void contar_argumentos(int cont,Celula *grafo){
	Celula *aux = fl;
...
/*Procedimento auxiliar para efetuar a marcacao dos
