 ...
 * */
void adiciona_digito(char *valor, int *numero_atual,int *contador_digito){

	if(*contador_digito > 0){
		*numero_atual = *numero_atual * 10;
		int aux = cria_valor_digito(valor);
		*numero_atual = *numero_atual | aux;
	}
	else{
		*numero_atual = cria_valor_digito(valor);
	}
}
